...
import { homeComment } from '../actions/comment_action';
...
function Comment(props) {
    ...
    const homepostdetail = state.post.homepostdetail ?? {}
    const list = homepostdetail.list ?? []
    ...
    const onSubmitHandler = (event) => {
        ...
        dispatch(homeComment(body)).then(response => {
